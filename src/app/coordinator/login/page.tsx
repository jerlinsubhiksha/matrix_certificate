...
export default function CoordinatorLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#F8FAFC]">
      {/* Subtle Background Elements - Coordinator uses slightly different tint */}
      <div className="absolute top-[10%] right-[-10%] w-[50%] h-[50%] bg-indigo-50 rounded-full blur-[100px] opacity-60 pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-purple-50 rounded-full blur-[100px] opacity-60 pointer-events-none" />
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 bg-white border border-[#E2E8F0] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder:text-gray-400"
                placeholder="coordinator@matrix.local"
              />
            </div>
            <div className="space-y-1.5">
