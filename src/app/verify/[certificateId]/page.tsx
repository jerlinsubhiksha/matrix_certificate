          ...
          <div className="p-8 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="font-medium text-lg">Matrix Hackathon 2026</p>
              </div>
              
              <div>
                <p className="text-xs font-bold text-[#64748B] uppercase tracking-wider mb-1">Achievement</p>
                <p className="font-medium text-lg text-blue-700">Best Innovation Award</p>
              </div>
              
              <div>
                <p className="text-xs font-bold text-[#64748B] uppercase tracking-wider mb-1">Issue Date</p>
                <p className="font-medium text-lg">August 13, 2026</p>
              </div>
            </div>
