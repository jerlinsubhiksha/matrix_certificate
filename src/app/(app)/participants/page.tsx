              ...
              <form onSubmit={handleAdd} className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Next.js Performance Tuning">Next.js Performance Tuning</option>
                    <option value="Framer Motion Animations">Framer Motion Animations</option>
                  </select>
                </div>
