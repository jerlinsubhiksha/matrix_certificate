...
const STATS = [
  { label: "Certificates", value: "0", trend: null, icon: Award, color: "blue" },
  { label: "Active Events", value: "0", trend: null, icon: TrendingUp, color: "indigo" },
  { label: "Coordinators", value: "0", trend: null, icon: Users, color: "slate" },
  { label: "Verification", value: "0", trend: null, icon: ShieldCheck, color: "emerald" },
];
