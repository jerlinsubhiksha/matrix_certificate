        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card border border-border/60 rounded-2xl p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <button 
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-background border border-border hover:bg-muted transition-colors rounded-xl font-medium shadow-sm group"
                onClick={(e) => {
                  e.preventDefault();
