...
// Mock data
const CERTIFICATES = [
  { id: "MTRX-2026-8F4K2X9Q", recipient: "Arjun Kumar", event: "Matrix Hackathon 2026", status: "ISSUED", date: "13 Aug 2026" },
  { id: "MTRX-2026-9A2B3C4D", recipient: "Priya Sharma", event: "Design Workshop", status: "PENDING_APPROVAL", date: "14 Aug 2026" },
  { id: "MTRX-2026-1X2Y3Z4W", recipient: "Rahul Dev", event: "AI Symposium", status: "REVOKED", date: "10 Aug 2026" },
];
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_4px_20px_rgba(15,23,42,0.03)] overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-t border-[#E2E8F0] bg-gray-50/50 flex justify-between items-center text-sm text-[#64748B]">
          <span>Showing 1 to 3 of 12,482 entries</span>
